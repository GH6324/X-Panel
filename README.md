...
#### 3、购买方式/渠道联系机器人：[@is_Chat_Bot](https://t.me/is_Chat_Bot)

#### 4、经常换的机器，去使用“免费基础版”就行，目前【安装界面】是有“两种方式”可选择的，

#### 5、对于有业务需求，比如做 TK 的，如果很多机器，比如：20台，50台，或者 100台 以上机器的宝子，若都要用【收费Pro版】的话，可以用【批量授权】：5 ——> 20台，8折，20 ——> 50台，7折，50 ——> 100台，6折，100 ——> 200台，5折，200台 ——> 以上，4折，这就是【批量折扣】。注：〔批量授权码〕要求最低5台以上，是“一码通用”，一个“授权码”，可以绑定验证多台 VPS 机器，并且有专属的“豹子号”授权码。
![63](./media/63.png)
————————————————————————————————

#### 6、购买赞助方式：打U ，或者 支付宝【口令红包】，不同公链 打U地址（USDT）：
...
#### 7、也可支付宝【口令红包】，请把“口令”发到下面的机器人：[@is_Chat_Bot](https://t.me/is_Chat_Bot) ，弄好之后，我会把〔授权码〕，机器人发给你，也会拉你进〔VIP 群〕，

————————————————————————————————
#### 8、不能重复用于不同的机器 VPS，后期视情况不定时会上涨价格；对于〔X-Panel 面板〕后期的“新功能”，都将在【付费Pro版】中进行更新，

#### 9、目前的【安装界面】，是有：两种可选，“免费基础版”一样可用，只是后期不再提供技术支持和重大更新，另外，在【免费基础版】中，【一键配置】功能将不再可用，全部放到了【付费Pro版】中，

#### 10、后期的开发精力，全部会放到【付费Pro版】中，免费基础版不删库，持续保留，想继续用的不影响，只是没有【新功能】可用，经常换的机器去用免费版翻墙足够。
...
若要安装指定的版本，请使用以下安装命令。 e.g., ver `v25.11.11`:

```
VERSION=v25.11.11 && bash <(curl -Ls "https://raw.githubusercontent.com/xeefei/x-panel/$VERSION/install.sh") $VERSION
```
------------
